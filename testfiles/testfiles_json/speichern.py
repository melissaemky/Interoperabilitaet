...
def speichern():
    ...
    for i in range(0, lk):  # Gespeicherte Karten werden durchlaufen
        ...
        if i == lk-1 and z == 0:  # Alle Karten durchlaufen und keine passende gefunden
            ...
            def write_benutzer(new_data, filename='/home/pi/config_dateien/schliessanlage.json'):
            ...
            def write_karten(new_data, filename='/home/pi/config_dateien/schliessanlage.json'):
                with open(filename, 'r+') as file:
                    file_data = json.load(file)
